...
const badgeDefs: BadgeDef[] = [
  ...
  { key: "POINTS_250",  name: "250 Club",  description: "Reached 250 points.",  icon: "zap" },
  ...
  { key: "STREAK_14", name: "Unstoppable",           description: "14 day learning streak.", icon: "rocket" },
  ...
  { key: "TUTOR_150", name: "Master Tutor",   description: "Tutored 150 sessions.", icon: "trophy" },
...
export async function seedBadgesOnce() {
  ...
  global.__badgesSeedingPromise = (async () => {
    // 1 single DB call — sequential upserts avoided
