...
import {
  Medal, Sparkles, ArrowLeft, Star, Trophy, Crown, Flame, Swords,
  Shield, Gem, Compass, Brain, Book, Users, Award, Sun, Moon,
  Calendar, Zap, MessageCircle, Clock, Rocket, Key, Lock,
} from "lucide-react";
